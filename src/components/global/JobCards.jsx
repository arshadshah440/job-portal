    ...
    <div>
      <div className="m-0">
        <div className="group mx-2 grid max-w-screen-md grid-cols-12 space-x-8 overflow-hidden rounded-lg border py-8 text-gray-700 shadow transition hover:shadow-lg sm:mx-auto">
          ...
          <div className="col-span-11 flex flex-col pr-8 text-left sm:pl-7">
            {job.company &&
            ...
            <div className="mt-5 flex-wrap gap-2 flex flex-col space-y-3 text-sm font-medium text-gray-500 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-2">
              <div className="">
                Experience:
